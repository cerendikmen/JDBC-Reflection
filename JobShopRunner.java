...
public class JobShopRunner
{
  ...
  public static void main ( String [] args ) throws Exception
  {
    ...
    /*jobShop.db.setPartCount("A", 10);
    jobShop.db.decrementPartCount("A");
    jobShop.db.incrementPartCount("A");
    jobShop.db.incrementPartCount("A");
    jobShop.db.incrementPartCount("B");
    List<Pair<String, Integer> > temp = new ArrayList<>();
    temp = jobShop.db.getInventory();
    for(int i= 0; i < temp.size(); i++)
    {
        System.out.println("i: " + i);
        System.out.println(" Part: " + temp.get(i).first);
        System.out.println(" Count: " + temp.get(i).second);
    }*/
    /************ DENEME END ***********************/
    //-----------------------------------------------------------------------------------------------------------------------------------------------
