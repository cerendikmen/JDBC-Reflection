...
public class JobShop
{
  ...
  void addProductRequest ( Part [] pr    ) {
      productRequests.add(pr);   
  }
  void addWorkingOrder   ( Order   order ) {
      workingOrders.add(order);
  }
  void addCompletedOrder ( Order   order ) {
      completedOrders.add(order);
  }
  void addMissingPart    ( String  part  ) { 
      missingParts.add(part);
  }

  //=================================================================================================================================================

  Part [] getNextProductRequest ()  {
    return productRequests.remove();
  }
  Order   getNextWorkingOrder   ()  { 
    return workingOrders.remove();
  }
  String  getNextMissingPart    ()  { 
    return missingParts.remove();
  }
